            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                        <i class="menu-icon mdi"><i class="fas fa-users"></i></i>
                        <span class="menu-title">Goście</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('admin') }}">Wszyscy</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.guests', ['filter' => 1]) }}">Potwierdzeni</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.guests', ['filter' => 2]) }}">Niepotwierdzeni</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.guests', ['filter' => 3]) }}">Transport</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.guests', ['filter' => 4]) }}">Hotel</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.guests', ['filter' => 5]) }}">Vege</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.guests', ['filter' => 6]) }}">Alergie</a></li>
                        </ul>
                    </div>
                </li>
